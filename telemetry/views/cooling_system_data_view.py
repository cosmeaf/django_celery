...
from telemetry.serializers.cooling_system_data_serializer import CoolingSystemDataSerializer, CoolingSystemDataDetailSerializer
...
class CoolingSystemDataModelViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action in ['create', 'list']:
            return CoolingSystemDataSerializer
        return CoolingSystemDataDetailSerializer
